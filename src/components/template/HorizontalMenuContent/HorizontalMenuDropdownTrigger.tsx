...
const HorizontalMenuDropdownTrigger = (
    ...
    const commonProps = {
        className: classNames(
            'font-bold text-sm inline-flex h-8 w-max items-center justify-center rounded-lg bg-background px-2.5 py-1 dark:text-gray-300 dark:hover:text-gray-100 text-gray-900 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors whitespace-nowrap',
            className,
            active &&
