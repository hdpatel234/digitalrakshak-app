...
export type CompletedListState = {
...
const initialState: CompletedListState = {
    initialLoading: true,
    customerList: [],
...
export const useCompletedListStore = create<
    CompletedListState & CompletedListAction
>((set) => ({
    ...initialState,
