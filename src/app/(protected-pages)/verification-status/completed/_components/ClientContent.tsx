...
import CompletedListTable from './CompletedListTable'
import CompletedListTableTools from './CompletedListTableTools'
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">{data.total} candidates currently completed</p>
                        </div>
                    </div>

                    <CompletedListTableTools
