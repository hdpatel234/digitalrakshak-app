...
const SERVICE_STATUS_STYLES: Record<string, string> = {
    ...
    'completed': STATUS_TAG_STYLES.warning,
...
const CompletedListTable = ({
    customerListTotal,
    pageIndex = 1,
    pageSize = 10,
}: CompletedListTableProps) => {
    const router = useRouter()

    const customerList = useCompletedListStore((state) => state.customerList)
    const isInitialLoading = useCompletedListStore(
