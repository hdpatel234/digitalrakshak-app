import InsufficiencyListProvider from './_components/InsufficiencyListProvider'
...
const getCandidatesFromInternalApi = async (
    ...
    url.searchParams.set('status', 'insufficiency')
...
export default async function Page({ searchParams }: PageProps) {
    ...
    return (
        <InsufficiencyListProvider customerList={data.list}>
            <ClientContent data={data} params={params} />
        </InsufficiencyListProvider>
    )
}
