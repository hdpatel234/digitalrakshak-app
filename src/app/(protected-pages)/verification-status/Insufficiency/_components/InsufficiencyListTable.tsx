...
type InsufficiencyListTableProps = {
...
const SERVICE_STATUS_STYLES: Record<string, string> = {
    ...
    'insufficiency': STATUS_TAG_STYLES.warning,
...
const InsufficiencyListTable = ({
    customerListTotal,
    pageIndex = 1,
    pageSize = 10,
}: InsufficiencyListTableProps) => {
    const router = useRouter()

    const customerList = useInsufficiencyListStore((state) => state.customerList)
    const isInitialLoading = useInsufficiencyListStore(
...
export default InsufficiencyListTable
