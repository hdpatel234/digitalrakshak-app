...
export type InProgressListState = {
...
const initialState: InProgressListState = {
    initialLoading: true,
    customerList: [],
...
export const useInProgressListStore = create<
    InProgressListState & InProgressListAction
>((set) => ({
    ...initialState,
