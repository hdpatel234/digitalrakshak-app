    ...
    return (
        <>
            ...
            <ConfirmDialog
                ...
                type="danger"
                title={t('selected.removeTitle')}
                onClose={handleCancel}
                onRequestClose={handleCancel}
                onCancel={handleCancel}
                onConfirm={handleConfirmDelete}
            >
                <p>{t('selected.removeConfirm')}</p>
            </ConfirmDialog>
            <Dialog
            ...
            >
                <h5 className="mb-2">{t('selected.sendMessageTitle')}</h5>
                <p>{t('selected.sendMessageDesc')}</p>
                <Avatar.Group
                    chained
...
export default InvitationListSelected
