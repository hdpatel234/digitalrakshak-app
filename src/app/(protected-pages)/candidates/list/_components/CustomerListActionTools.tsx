...
const CustomerListActionTools = () => {
    ...
    const handleExport = async () => {
        ...
        try {
            const response = await fetch(`/api/client/candidates/export?format=${format}`, {
                method: 'GET'
            })
            ...
            let filename = `candidates-export-${new Date().toISOString().split('T')[0]}.${format}`
            ...
            toast.push(
                <Notification title="Error" type="danger">
                    Failed to export candidates. Please try again.
                </Notification>,
                { placement: 'top-center' }
            )
        } finally {
        ...
        <div className="flex flex-col md:flex-row gap-3">
            ...
            >
                <div className="flex flex-col h-full justify-between">
                    <h5 className="mb-4">Export Candidates</h5>
